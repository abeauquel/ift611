...
Window::Window(MySysInfo mySysInfo)
{
    ...
    QPainterPath cpuText;
    cpuText.addText(0, 20, textFont, tr("CPU"));
    ...
    memoryText.addText(0, 33 + 20, textFont, tr("Memory"));
    ...
    QPainterPath IOText;
    IOText.addText(0, 66 + 20, textFont, tr("IO"));
    ...
    renderAreas[1] = new RenderArea(cpuGraph);
    renderAreas[2] = new RenderArea(memoryText);
    renderAreas[3] = new RenderArea(memoryGraph);
    renderAreas[4] = new RenderArea(IOText);
    renderAreas[5] = new RenderArea(IOGraph);
//    renderAreas[0] = new RenderArea(rectPath);
//    renderAreas[1] = new RenderArea(roundRectPath);
//    renderAreas[2] = new RenderArea(ellipsePath);
//    renderAreas[1] = new RenderArea(piePath);
...
//    renderAreas[8] = new RenderArea(starPath);
    ...
    for (int i = 0; i < NumRenderAreas; ++i)
        topLayout->addWidget(renderAreas[i], i / 2, i % 2);
